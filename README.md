...
- **[zap-nginx-headers](https://github.com/ccradle/findABed/tree/main/openspec/changes/archive/2026-03-30-zap-nginx-headers/)** — OWASP ZAP baseline: HSTS, CSP, COEP, server_tokens off, nginx add_header inheritance fix, Cache-Control for SPA. 9/9 tasks. Archived 2026-03-30.
- **[import-hardening](https://github.com/ccradle/findABed/tree/main/openspec/changes/archive/2026-03-30-import-hardening/)** — Fix admin import navigation (Link vs a href), CSV injection prevention (CWE-1236), MIME validation, field length validation, 29 new tests. 15/15 tasks. Tagged v0.22.0. Archived 2026-03-30.
