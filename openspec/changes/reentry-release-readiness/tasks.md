...
- [x] 11.2 **`frontend/src/i18n/es.json`** — Spanish translations for all 4 new keys + the privacy-note reconciliation. Spanish copy was warroom-output drafted (Casey/Keisha voice), not machine translation.
