...
- [x] T-FU-4: **PR #96 merged with all 11 scans green** — Backend (Java 25 + Maven), Frontend (Node 20 + Vite), DV Access Control Canary, CodeQL × 3, Legal Language Scan, E2E (Playwright + Karate), and CodeQL meta. Merge commit: 6dba57a, 2026-04-10 10:09 UTC. **Released as v0.32.2** at commit dcd37cc on 2026-04-10 (release notes: <https://github.com/ccradle/finding-a-bed-tonight/releases/tag/v0.32.2>). Deploy held — bundled with v0.33.0.
