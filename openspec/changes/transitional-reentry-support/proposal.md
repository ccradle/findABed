...
- **Flyway HWM**: V89 → V93 (4 migrations: V90 / V91 / V92 / V93). Renumbered twice — V79–V82 → V85–V88 post-v0.51.0 Phase F, then V85–V88 → V90–V93 (2026-04-26) after Phase G claimed V85/V87/V88/V89. Verify actual HWM at implementation start in case any further pre-reentry slice claims additional slots.
