...
Per-tenant hold duration configuration for soft-hold bed reservations, exposed via the admin panel and applied to new holds. Supports default 90-minute holds for emergency outreach and extended windows (180–240 minutes) for hospital discharge and reentry deployments where transport logistics extend the time between hold creation and client arrival.
