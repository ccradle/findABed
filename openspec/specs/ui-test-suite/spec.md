...
Playwright browser automation tests covering all critical user workflows: login, outreach bed search, coordinator availability updates, and admin panel operations.
