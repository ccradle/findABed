# Capability: hmis-admin

## Purpose
Provides administrative UI for HMIS export management, including export status monitoring, data preview, history, vendor configuration, and manual controls.
