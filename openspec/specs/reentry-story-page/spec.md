# reentry-story-page Specification

## Purpose

A capability deep-dive page (`demo/reentry-story.html`) and supporting screenshot inventory tell the reentry-on-release-day story for navigators, mirroring the structural pattern of the DV referral capability deep-dive (`demo/dvindex.html`). The page is reachable from the front-door "See It Work" grid, carries reciprocal cross-page links from sibling capability deep-dives and audience pages, is SEO-discoverable, and contains zero fictional pilots, partnerships, or named real-world stakeholders.
